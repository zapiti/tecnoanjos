...
buildPlusLessButtom(BuildContext context, Function(int) alterations) {
  ...
  controllPlussLessButton.selection =
      TextSelection.fromPosition(TextPosition(offset: controllPlussLessButton.text.length));
...
class _PlusLessComponentState extends State<PlusLessComponent> {
  ...
  Widget build(BuildContext context) {
    return  !widget.containsValue? RaisedButton(
                ...
                children: <Widget>[
                  !widget.containsValue
                      ...
                      child: TextField(
                        ...
                        onChanged: (text) {
                          if ((int.tryParse(widget.controller.text) ?? 0) <= 0) {
                            setState(() {
                              widget.containsValue = !widget.containsValue;
                            });
                          }
                  ...
                  !widget.containsValue ? SizedBox() : lineViewWidget(height: 0.5),
                  Row(

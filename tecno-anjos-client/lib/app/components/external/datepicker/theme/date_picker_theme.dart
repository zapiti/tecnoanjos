...
class DatePickerTheme with DiagnosticableTreeMixin {
  ...
  const DatePickerTheme({
    ...
    this.doneStyle = const TextStyle(color: Colors.black54, fontSize: 18,fontWeight: FontWeight.bold),
    this.itemStyle = const TextStyle(color: Colors.black54, fontSize: 18,fontWeight: FontWeight.bold),

...
class ViewAttendanceWidget extends StatefulWidget {
  ...
  final double topFixSized;
  ViewAttendanceWidget({this.childCenter,this.childBottom,this.childTop, this. topFixSized});
  @override
          ...
          child:   ListView(
            children: [
              widget.childTop == null ? SizedBox():     Container(
                height: widget.topFixSized ?? MediaQuery.of(context).size.height * 0.2,

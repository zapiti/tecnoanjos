...
import 'package:tecnoanjosclient/app/modules/general/home/modules/attendance/widget/attendance_item_list_widget.dart';
                ...
                Expanded(
                  ...
                  ElevatedButton(
                    ...
                    child: Container(
                      child: Text(
                        "Todos",
                        style: AppThemeUtils.normalSize(fontSize: 11),
                      ),
                    ),
                    onPressed: () {
                      setState(() {
  ...
  Widget _buildEventList(List<Attendance> listitems) {
    return GroupedListView(
      ...
      itemBuilder: (context, element) => attendanceItemListWidget(
          context, element, element.status,
          showline: true),

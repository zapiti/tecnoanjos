...
class SugestionRepository {
  ...
  Future<ResponsePaginated> creatSuggestion(
      String descricao, bool isSugestion) async {
    var result = await _requestManager.requestWithTokenToForm(SUGESTOES,Flavor.I.getString(Keys.apiUrl),

...
import 'package:tecnoanjostec/app/components/select/select_button.dart';
...
class BuildAlterPass extends StatefulWidget {
  ...
  BuildAlterPass(
      this.context, this.isLoadRequest, this._scaffoldKey, this.isPhone);

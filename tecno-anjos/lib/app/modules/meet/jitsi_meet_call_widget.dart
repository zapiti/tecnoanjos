...
import 'package:tecnoanjostec/app/components/blick_button.dart';
...
class _JitsiMeetCallWidgetState extends State<JitsiMeetCallWidget> {
  ...
  final nameText = TextEditingController(text: "Tecnoanjo tecnico");
  final emailText = TextEditingController(text: "tecnoanjotecnico@email.com");
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      nameText.text =
          widget?.attendance?.userTecno?.name ?? "Tecnoanjo tecnico";
      emailText.text =
          widget?.attendance?.userTecno?.email ?? "tecnoanjotecnico@email.com";
    });
  }
  ...
  bool inCall(DocumentSnapshot documentSnapshot) {
    if (documentSnapshot?.data() == null) {
      return false;
    } else if (!(documentSnapshot.data()[MyCurrentAttendanceBloc.CLIENT] ??
        false)) {

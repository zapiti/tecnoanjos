...
void showNewAttendanceDialog(BuildContext context,
  ...
  var atendimento = Modular.get<StartCalledBloc>();
  if (atendimento.currentAttendance != null) {
    TypePopup.show(
      context: context,

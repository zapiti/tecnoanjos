...
//
// final String _dsn =
//     'https://84adb9e186654338bbe51e62c03ad987@o508321.ingest.sentry.io/5600654';
//
...
//   if (localUser != null) {
//     currentUser = CurrentUser.fromMap(Jwt.parseJwt(localUser));
//   }
//   return User(
//       id: currentUser?.id?.toString() ?? "-1",
//       email: currentUser?.name ?? currentUser?.telephone ?? "Desconhecido",
//       extras: {
//         "user": currentUser?.toMap() ?? {},
//         "version": Flavor.I.getString(actualVersion),

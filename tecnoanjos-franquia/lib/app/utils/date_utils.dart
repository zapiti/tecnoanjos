...
class MyDateUtils {
  static String parseDateTimeFormat(dynamic date, {format = "dd/MM/yyy"}) {
  ...
  static String serverHoursToHours(String startShift) {
    print(startShift);
    if(startShift == null){
      return "";
    }else if (startShift.length >= 3){
      return "${startShift.substring(0, 2)}:${startShift.substring(2, 3)}";
    }else {return "";}
  }
}
